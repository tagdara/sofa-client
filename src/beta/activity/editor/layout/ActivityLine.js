...
import ActivityItemActions from 'beta/activity/editor/layout/ActivityItemActions';
import { Paper, SimpleGrid } from '@mantine/core';

const ActivityLine = props => {
    // <Paper elevation={0} onClick={props.onClick} sx={{ display: "flex", borderRadius:4, width: "100%"}}></Paper>
    return (
        <Paper onClick={props.onClick} style={{ padding: "8px 16px", display: "flex", borderRadius:4, width: "100%"}}>
