...
export default function ComputerHero(props) {
    ...
    const buttonLayout = {
        upstairs:   [   
            ...
            { endpointId: "matrix:output:O5", label: "3", defaultInput: "PC3", outletEndpointId: "tplink:plug:8006A33CCFD62AE0DF1753D5A9BCD86E1AD7F78E02"},
            { endpointId: "matrix:output:O6", label: "4", defaultInput: "PC4", outletEndpointId: "tplink:plug:8006A33CCFD62AE0DF1753D5A9BCD86E1AD7F78E03"}
        ],
        downstairs: [   
